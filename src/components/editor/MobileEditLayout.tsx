          ...
          <div className="md:hidden sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-[#eceae4] px-4 py-3 flex items-center justify-between gap-2 shadow-sm shrink-0">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button
                onClick={openShareModal}
                disabled={isSharing}
                className="hidden p-2 rounded-xl bg-white/50 border border-[#eceae4] text-[#1c1c1c] hover:bg-white shadow-sm shrink-0"
                title="Share Resume"
              >
                     ...
                     >
                       ...
                       {data.blockOrder.map((blockId, index) => {
                        ...
                        <div className="pt-2 border-t border-[#eceae4] flex flex-col gap-2 pb-1 mt-1">
                          ...
                          >
                            <LucideIcons.Plus className="w-3.5 h-3.5 text-accent" /> {t("editor.layout.addListView")}
                          </button>
                          <button
                            onClick={() => {
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl text-xs tracking-widest text-[#5f5f5d] hover:text-accent hover:bg-black/5 transition-colors bg-[#f7f4ed] border border-[#eceae4]"
                          >
                            <LucideIcons.Plus className="w-3.5 h-3.5 text-accent" /> {t("editor.layout.addTagView")}
                          </button>
                        </div>
                     </motion.div>
                   )}
            ...
            {!isMobile && (
              <div className="flex items-center gap-1 pl-2 border-l border-white/10 shrink-0">
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-[10px] sm:text-xs tracking-widest text-text-secondary hover:text-accent hover:bg-white/5 transition-colors whitespace-nowrap"
                >
